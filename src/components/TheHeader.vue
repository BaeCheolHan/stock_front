<template>
  ...
  <div v-if="userInfo" id="sidenav-lnb" class="sidenav">
    <div>
      <div class="flex">
  ...
  <div v-else id="sidenav-lnb" class="sidenav">
    <div>
      <div class="flex">
        <div class="profile-wrap" @click="goDashboard">
          <button class="kakao-login-small mg-l-5" v-on:click="kakaoLoginBtn"></button>
        </div>
        <div>
          <button class="closer mg-r-10" @click="closeNav" style="color: #818181;">&times;</button>
        </div>
